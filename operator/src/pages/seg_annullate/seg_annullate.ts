...
@Component({
  selector: 'page-seg_annullate',
  templateUrl: 'seg_annullate.html'
})
export class SegAnnullatePage {
  ...
  constructor(public navCtrl: NavController, private fire: AngularFireAuth, public afDatabase: AngularFireDatabase, public loadingCtrl: LoadingController) {
    ...
    this.itemsRef = afDatabase.list('/segnalazioni', ref => ref.orderByChild('stato').equalTo(1));
